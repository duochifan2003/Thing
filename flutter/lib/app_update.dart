...
List<String> parseAuthenticodeThumbprints(String raw) {
...
final defaultPinnedAuthenticodeThumbprints = parseAuthenticodeThumbprints(
  configuredAuthenticodeThumbprint,
);
